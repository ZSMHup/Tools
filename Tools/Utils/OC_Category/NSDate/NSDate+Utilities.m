...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + AY_D_HOUR * dHours;
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + AY_D_MINUTE * dMinutes;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (BOOL)jk_isSameWeekAsDate: (NSDate *) aDate
{
    ...
    return (fabs([self timeIntervalSinceDate:aDate]) < AY_D_WEEK);
...
- (BOOL) jk_isNextWeek
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + AY_D_WEEK;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
...
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + AY_D_HOUR * dHours;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + AY_D_MINUTE * dMinutes;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (NSInteger) jk_minutesAfterDate: (NSDate *) aDate
{
    ...
    return (NSInteger) (ti / AY_D_MINUTE);
}
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + AY_D_MINUTE * 30;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
